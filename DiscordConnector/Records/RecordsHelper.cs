...
public static class Helper
{
	...
	public static List<CountResult> TopNResultForCategory(string key, int n) =>
		TopNResultForCategory(key, n, DateHelper.DummyDateTime, DateHelper.DummyDateTime);
	...
	public static List<CountResult> BottomNResultForCategory(string key, int n) =>
		BottomNResultForCategory(key, n, DateHelper.DummyDateTime, DateHelper.DummyDateTime);
	...
	internal static int CountUniquePlayers(string key, TimeRange timeRange)
	{
		...
		{
			var results = DiscordConnectorPlugin.StaticDatabase.CountAllRecordsGrouped(key);
			return results.Count;
		}

		// All others expand out the time to a range for querying
		var dates = DateHelper.StartEndDatesForTimeRange(timeRange);
