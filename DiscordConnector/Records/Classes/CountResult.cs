...
public class CountResult
{
	...
	public static int CompareByCount(CountResult cr1, CountResult cr2) => cr1.Count.CompareTo(cr2.Count);

	public static int CompareByName(CountResult cr1, CountResult cr2) => cr1.Name.CompareTo(cr2.Name);
	...
	public override string ToString() => $"{this.Name}: {this.Count}";
}
